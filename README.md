...
Resistance is also shown by default above aegis as it can negate powerful conditions such as fear and immobilize, but can be hidden by disabling the "resistance" group if you just want to focus on stability/aegis/mitigation.
